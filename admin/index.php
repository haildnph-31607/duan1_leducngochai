    ...
    switch ($act) {
        ...
        case 'addsp':
            ...
            if (isset($_POST['submit'])) {
                ...
                if (empty($quantityS)) {
                    $_SESSION['err']['quantity'] = 'Bạn chưa nhập số lương sản phẩm';
                }
                if (empty($PriceS)) {
        ...
        case 'suasp':
            ...
            break;
        case 'vnpay':
            $all_VNPAY = select_all_VNPAY();    

            include('./payment/listPayVNPAY.php');
            break;
        case 'bienthe':
            if(isset($_GET['idsp'])){
                $idsp= $_GET['idsp'];
                $select_bienthe = select_bienthe($idsp);
            }
           
            // var_dump($select_bienthe);die(); 
            include('./bienthe/list.php');
            break;
        case 'momo':
            $all_MOMO = select_all_MOMO();      
            include('./payment/listPayMomo.php');
            break;
        case 'updatesp':
            $list_dm = select_danhmuc();
            if (isset($_POST['update'])) {
        ...
        case 'thongke':
            ...
            if(isset($_POST['loc'])){
                ...
                $thongke_dt_nt = doanhthutheothang($from,$to);
                // var_dump();die();
            }else{
        ...
        case 'sanphambl':
            if(isset($_GET['idsp'])){
                $idsp= $_GET['idsp'];
                $select_bl_sp= select_bl_sp($idsp); 
             
                $select_bl_bl = select_bl_bl($idsp);
            }
            include('./spbinhluan.php');
            break;
