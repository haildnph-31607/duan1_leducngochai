            ...
            <table>
                            ...
                            <?php foreach($resultsmycart as $mycart):?>
                                <tr>
                                    ...
                                    <?php }else if($mycart['trangthai'] ==1 || $mycart['trangthai'] ==2 ){ ?>
                                        <button class="hethan">Hủy Đơn</button>
                                        <?php }else if($mycart['trangthai'] == 4){?>
                                            <button class="hethan">Đã Hủy</button>
                                            <?php }else if($mycart['trangthai'] == 3){} ?>
                                         <a href="index.php?act=chitiethoadon&id=<?php echo $mycart['id'] ?>"><button class="chitiet">Chi Tiết</button></a>
                                    </td>
