...
<body>
  <div class="container1">
    ...
    <div class="order-details">
      ...
      <ul>
        <li class="order-item">
          <div class="order-item__name">Ma Hoa Don MOMO Của Bạn</div>
          <div class="order-item__price"><?php if(isset($_GET['partnerCode'] )){
        ...
        <li class="order-item">
          ...
          <div class="order-item__price"><?php  if(isset($_GET['amount'])){
            echo $_GET['amount'];
          } ?></div>
        </li>
